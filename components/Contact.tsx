      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-6xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
          ...
          <div className="bg-brand-900 text-white p-10 lg:p-14 lg:w-2/5 flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
                <h2 className="font-serif text-3xl font-bold mb-6">Cesar Valls Propiedades</h2>
                <p className="text-white mb-6 leading-relaxed">
                  A la hora de comprar, vender o alquilar hacelo siempre acompañado de un profesional matriculado.
                </p>
                
                <p className="text-white text-sm mb-6">📍 Andrade 52, Glew</p>
                {/* <p className="text-white text-sm mb-6">📲 <a href="tel:+541155125144" className="underline">Llamar a Cesar</a></p> */}
                <p className="text-white text-sm">🔨 Matrícula 4220</p>
                <br />
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-white">Teléfono / WhatsApp</h4>
                    <a href="tel:+541155125144" className="text-white hover:text-[#f7931e] transition-colors block mt-1">+54 11 5512 5144</a>
                    <a href="https://wa.me/541155125144" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#f7931e] transition-colors block mt-1">Enviar WhatsApp</a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-white block mt-1">info@cesarvalls.propiedades</span>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white mt-1">Andrade 52, Glew</p>
                  </div>
                </div>
              </div>
            </div>
